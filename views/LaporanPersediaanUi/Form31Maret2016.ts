 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Monitorstok/filterjumlahstokmaret16bu.php the original file
 */
final class Form31Maret2016
{
...
namespace his.FatmaPharmacy.views.LaporanPersediaanUi.Form31Maret2016 {
...
tlm.app.registerModule(class extends spa.BaseModule {
                ...
                box: {
                    ...
                    formGroup_2: {
                        ...
                        select: {
                            ...
                            option_2: {value: 1, label: tlm.stringRegistry._<?= $h("Per Kelompok Barang") ?>}
                        }
                    }
                }
            },
    ...
    constructor(divElm) {
        ...
        const laporanPersediaanWgt = new spl.AjaxFormWidget({
            element: divElm.querySelector(".laporanPersediaanFrm"),
            /** @param {his.FatmaPharmacy.views.LaporanPersediaanUi.Form31Maret2016.Fields} data */
            loadData(data) {
        ...
        this._widgets.push(laporanPersediaanWgt);
        tlm.app.registerWidget(this.constructor.widgetName, laporanPersediaanWgt);
    }
});
</script>
