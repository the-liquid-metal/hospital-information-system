...
namespace his.FatmaPharmacy.views.MonitorStok.FilterJumlahStokSept16Bu {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    constructor(divElm) {
        ...
        const laporanPersediaanWgt = new spl.AjaxFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.MonitorStok.FilterJumlahStokSept16Bu.Fields} data */
            loadData(data) {
