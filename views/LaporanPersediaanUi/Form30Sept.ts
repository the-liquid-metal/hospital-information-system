 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Monitorstok/filterjumlahstoksept.php the original file
 */
final class Form30Sept
{
...
namespace his.FatmaPharmacy.views.LaporanPersediaanUi.Form30Sept {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    constructor(divElm) {
        ...
        const laporanPersediaanWgt = new spl.AjaxFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.LaporanPersediaanUi.Form30Sept.Fields} data */
            loadData(data) {
