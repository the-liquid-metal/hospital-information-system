 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Monitorstok/filterjumlahstokjuni16bu.php the original file
 */
final class FormJuni2016
{
...
namespace his.FatmaPharmacy.views.LaporanPersediaanUi.FormJuni2016 {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    constructor(divElm) {
        ...
        const laporanPersediaanWgt = new spl.AjaxFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.LaporanPersediaanUi.FormJuni2016.Fields} data */
            loadData(data) {
