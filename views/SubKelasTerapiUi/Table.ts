 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Subkelasterapi/index.php the original file
 */
final class Table
{
...
namespace his.FatmaPharmacy.views.SubKelasTerapiUi.Table {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    _structure = {
        row_1: {
            widthColumn: {
                heading3: {text: tlm.stringRegistry._<?= $h("Daftar Subkelas Terapi") ?>}
            }
        },
        row_2: {
            widthColumn: {
    ...
    constructor(divElm) {
        ...
        const saringWgt = new spl.StaticFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.SubKelasTerapiUi.Table.FormFields} data */
            loadData(data) {
                kodeFld.value = data.kode;
                kelasTerapiFld.value = data.kelasTerapi;
                namaFld.value = data.subkelasTerapi;
            },
            submit() {
                itemWgt.refresh({
                    query: {
