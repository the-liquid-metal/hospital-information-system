 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/laporan/laporan_harian2_tdkterlayani.php the original file
 *
 * TODO: php: uncategorized: tidy up
 */
final class LaporanHarian2TakTerlayani
{
    ...
    foreach ($daftarPeringatan as $peringatan) {
        ...
        $html .=
            '<tr>
                    ...
                    <td class="text-right">' . $toUserInt($peringatan->jumlah1) . '</td>
                    <td class="text-right">' . $toUserInt($peringatan->jumlah2) . '</td>
