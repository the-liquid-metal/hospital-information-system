 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Penerimaan/print_v_03.php the original file
 */
final class PrintV03
{
...
<table class="p_table">
    ...
    <tfoot>
        ...
        <tr>
            <td colspan="7" style="border:0">Terbilang: <?= FH::terbilang($totalAkhir) ?></td>
        </tr>
    </tfoot>
</table>
