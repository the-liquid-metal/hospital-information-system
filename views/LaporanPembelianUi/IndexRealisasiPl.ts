 ...
 */
final class IndexRealisasiPl
{
    private string $output;

    public function __construct(string $registerId, string $dataUrl, string $reportWidgetId)
    {
...
namespace his.FatmaPharmacy.views.LaporanPembelian.IndexRealisasiPl {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    _structure = {
        ...
        form: {
            ...
            button: {class: ".exportToExcelBtn", type: "warning", text: tlm.stringRegistry._<?= $h("Export To Excel") ?>}
        },
        row: {
            widthTable: {
                class: ".itemTbl",
        ...
        const itemWgt = new spl.TableWidget({
            ...
            columns: {
                ...
                15: {formatter(unused, item) {
                    ...
                    return userFloat(jumlahTerima * hargaTerima);
                }},
