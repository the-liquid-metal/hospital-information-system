 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/eresepdepo/struk-baru.php the original file
 */
final class ViewStruk
{
    ...
    public function __construct(
        ...
        string $cetakStruk3WidgetId,
        string $formWidgetId,
        string $formEtiketWidgetId,
...
namespace his.FatmaPharmacy.views.EresepDepoUi.FormStrukBaru {
    export interface ContainerFields {
        pasien:        PasienFields;
        penjualan:     PenjualanFields;
        daftarObat:    DaftarObatFields;
        formData:      FormFields;
    ...
    export interface PasienFields {
        ...
        noResep:        "no_resep";
        dariTanggal:    "tglResep1";
        sampaiTanggal:  "tglResep2";
        kodeRekamMedis: "no_rm";
        noPendaftaran:  "no_daftar2";
        iter:           "iter";
        keterangan:     "keterangan";
        pembungkus:     "totalpembungkus";
        transfer:       "transfer";
    ...
    export interface PenjualanFields {
        subtotal:       "totaljual";
        diskon:         "totaldiskon";
        jasaPelayanan:  "totaljp";
    }

    export interface DaftarObatFields {
        kodeRacik:        "kode_racik";
        namaRacik:        "nama_racik";
        noRacik:          "no_racik";
        namaBarang:       "nama_barang";
        jumlahPenjualan:  "jlhPenjualan";
        keteranganJumlah: "ketjumlah";
        hargaJual:        "harga_jualnya";
    }
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    _structure = {
        ...
        row_8: {
            column: {
                ...
                button_7: {class: ".pengkajianBtn", text: tlm.stringRegistry._<?= $h("Ceklis Resep") ?>},
        ...
        modal: {
            class: ".prescriptionErrorMdl",
            form: {
                class: ".prescriptionErrorFrm",
                row_1: {
                    box: {
    ...
    constructor(divElm) {
        ...
        /** @type {HTMLInputElement} */  const pasienStc = divElm.querySelector(".pasienStc");
        /** @type {HTMLInputElement} */  const alamatStc = divElm.querySelector(".alamatStc");
        /** @type {HTMLInputElement} */  const ruangStc = divElm.querySelector(".ruangStc");
        /** @type {HTMLInputElement} */  const caraBayarStc = divElm.querySelector(".caraBayarStc");
        /** @type {HTMLInputElement} */  const operatorStc = divElm.querySelector(".operatorStc");
        /** @type {HTMLInputElement} */  const noResep1Stc = divElm.querySelector(".noResep1Stc");
        /** @type {HTMLInputElement} */  const dariTanggalStc = divElm.querySelector(".dariTanggalStc");
        /** @type {HTMLInputElement} */  const sampaiTanggalStc = divElm.querySelector(".sampaiTanggalStc");
        /** @type {HTMLInputElement} */  const kodeRekamMedisStc = divElm.querySelector(".kodeRekamMedisStc");
        /** @type {HTMLInputElement} */  const noPendaftaranStc = divElm.querySelector(".noPendaftaranStc");
        /** @type {HTMLInputElement} */  const iterStc = divElm.querySelector(".iterStc");
        /** @type {HTMLInputElement} */  const subtotalStc = divElm.querySelector(".subtotalStc");
        /** @type {HTMLInputElement} */  const diskonStc = divElm.querySelector(".diskonStc");
        /** @type {HTMLInputElement} */  const pembungkusStc = divElm.querySelector(".pembungkusStc");
        /** @type {HTMLInputElement} */  const jasaPelayananStc = divElm.querySelector(".jasaPelayananStc");
        /** @type {HTMLInputElement} */  const totalStc = divElm.querySelector(".totalStc");
        /** @type {HTMLInputElement} */  const keteranganStc = divElm.querySelector(".keteranganStc");
        ...
        /** @type {HTMLSelectElement} */ const noResepStc = divElm.querySelector(".noResepStc");
        ...
        const divWgt = new spl.DinamicContainerWidget({
            element: divElm,
            dataUrl: "<?= $dataUrl ?>",
            /** @param {his.FatmaPharmacy.views.EresepDepoUi.FormStrukBaru.ContainerFields} data */
            loadData(data) {
                ...
                subtotalStc.innerHTML = userInt(penjualan.subtotal);
                diskonStc.innerHTML = userInt(penjualan.diskon);
                pembungkusStc.innerHTML = userInt(pasien.pembungkus);
                jasaPelayananStc.innerHTML = userInt(penjualan.jasaPelayanan);
                totalStc.innerHTML = userInt(data.grandTotal);
                keteranganStc.innerHTML = pasien.keterangan;

                itemWgt.load(data.daftarObat);
                prescriptionErrorWgt.loadData(data.formData);
        ...
        const prescriptionErrorWgt = new spl.AjaxFormWidget({
            element: divElm.querySelector(".prescriptionErrorFrm"),
            /** @param {his.FatmaPharmacy.views.EresepDepoUi.FormStrukBaru.FormFields} data */
            loadData(data) {
        ...
        // NOT EXACTLY same as original table
        const itemWgt = new spl.TableWidget({
            element: divElm.querySelector(".itemTbl"),
            columns: {
                1: {formatter: tlm.rowNumGenerator}, // EXACT STATEMENT: $obat->kodeRacik ? "" : $daftarObat2[$j]->noObat
                2: {field: "namaBarang"}, // EXACT STATEMENT: ($obat->kodeRacik ? $daftarObat2[$j]->noRacik : "") . $obat->namaBarang
                3: {formatter(unused, item) {
                    const {kodeRacik, jumlahPenjualan, keteranganJumlah} = item;
                    return jumlahPenjualan + (kodeRacik ? " / " + keteranganJumlah : "");
                }},
        ...
        printBtn.addEventListener("click", () => {
            const widget = tlm.app.getWidget("_<?= $cetakStruk3WidgetId ?>");
            widget.show();
            widget.loadData({noResep: printBtn.value}, true);
        });

        etiketBtn.addEventListener("click", () => {
            const widget = tlm.app.getWidget("_<?= $formEtiketWidgetId ?>");
            widget.show();
        ...
        verifikasiBtn.addEventListener("click", () => {
            $.post({
                url: "<?= $verifikasiUrl ?>",
                data: {q: "", id: verifikasiBtn.dataset.no}
            });
        ...
        this._widgets.push(divWgt, prescriptionErrorWgt, itemWgt);
