 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/eresepdepo/cetak-struk-lq.php the original file
 */
final class CetakStrukLq
{
...
<div class="print_wrapper">
    ...
    <table class="daftar_obat">
        ...
        <tbody>
        <?php foreach ($halaman as ["i" => $i, "subtotal_harga" => $subtotalHarga]): ?>
            <?php $obat = $daftarObat[$i] ?>
            <?php if ($obat->subtotalJumlah): ?>
                <tr>
                    <td><?= $no++ ?></td>
                    <td><?= $obat->namaBarang ?></td>
                    <td class="text-right"><?= $toUserInt($obat->subtotalJumlah) ?></td>
                    <td>Rp</td>
                    <td class="text-right"><?= $toUserInt($subtotalHarga) ?></td>
                </tr>
            <?php endif ?>
        <?php endforeach ?>
        </tbody>
    ...
    <?php if ($h + 1 == $jumlahHalaman): ?>
        <table class="total">
            <tr>
                ...
                <td>:</td>
                <td>Rp</td>
                <td class="text-right"><?= $toUserInt($daftarLainnya[$h]["totalJual"]) ?></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>:</td>
                <td>Rp</td>
                <td class="text-right"><?= $toUserInt($daftarLainnya[$h]["totalJasaPelayanan"]) ?></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                ...
                <td>:</td>
                <td>Rp</td>
                <td class="text-right"><?=  $toUserInt($daftarLainnya[$h]["grandTotal"]) ?></td>
            </tr>
        </table>
