 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Stokopname/searchlaporanfloorstock.php the original file
 * last exist of tlm\his\FatmaPharmacy\views\StokopnameUi\SearchLaporanFloorStock: commit-e37d34f4
 */
final class FormTriwulan3
{
...
namespace his.FatmaPharmacy.views.LaporanFloorStockUi.FormTriwulan3 {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    constructor(divElm) {
        ...
        const triwulanWgt = new spl.AjaxFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.LaporanFloorStockUi.FormTriwulan3.Fields} data */
            loadData(data) {
