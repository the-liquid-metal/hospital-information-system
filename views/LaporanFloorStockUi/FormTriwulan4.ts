 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Stokopname/searchlaporanfloorstockdes.php the original file
 * last exist of tlm\his\FatmaPharmacy\views\StokopnameUi\SearchLaporanFloorStockDes: commit-e37d34f4
 */
final class FormTriwulan4
{
...
namespace his.FatmaPharmacy.views.LaporanFloorStockUi.FormTriwulan4 {
...
tlm.app.registerModule(class extends spa.BaseModule {
                ...
                box: {
                    ...
                    formGroup_1: {
                        ...
                        select: {
                            class: ".bulanFld",
                            name: "bulan",
                            option: {value: "12", label: tlm.stringRegistry._<?= $h("Bulan") ?>}
                        }
                    }
                }
            },
    ...
    constructor(divElm) {
        ...
        const triwulanWgt = new spl.AjaxFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.LaporanFloorStockUi.FormTriwulan4.Fields} data */
            loadData(data) {
