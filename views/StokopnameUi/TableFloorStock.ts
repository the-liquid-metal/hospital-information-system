 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Stokopname/listfloorstock.php the original file
 */
final class TableFloorStock
{
    ...
    public function __construct(
        string $registerId,
        string $dataUrl,
        string $floorDesemberWidgetId,
        string $floorMaretWidgetId,
        string $formWidgetId,
...
namespace his.FatmaPharmacy.views.Stokopname.ListFloorStock {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    _structure = {
        ...
        row_3: {
            widthColumn: {
                ...
                button_2: {class: ".list12Btn", text: tlm.stringRegistry._<?= $h("List Desember") ?>},
                button_3: {class: ".list03Btn", text: tlm.stringRegistry._<?= $h("List Maret") ?>},
            }
        },
        row_4: {
            widthColumn: {
    ...
    constructor(divElm) {
        ...
        divElm.querySelector(".list12Btn").addEventListener("click", () => {
            tlm.app.getWidget("_<?= $floorDesemberWidgetId ?>").show();
        });

        divElm.querySelector(".list03Btn").addEventListener("click", () => {
            tlm.app.getWidget("_<?= $floorMaretWidgetId ?>").show();
        });
