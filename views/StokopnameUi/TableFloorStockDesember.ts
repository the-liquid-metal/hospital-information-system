 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Stokopname/listfloorstocksept.php the original file
 */
final class TableFloorStockDesember
{
...
namespace his.FatmaPharmacy.views.Stokopname.ListFloorStockSept {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    _structure = {
        row_1: {
            widthColumn: {
                header3: {text: tlm.stringRegistry._<?= $h("Daftar Floor Stok Desember") ?>}
            }
        },
        row_2: {
            widthColumn: {
