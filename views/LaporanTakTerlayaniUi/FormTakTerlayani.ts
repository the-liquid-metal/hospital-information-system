 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/laporan/laporan_harian_tdkterlayani.php the original file
 * last exist of tlm\his\FatmaPharmacy\views\LaporanUi\LaporanHarianTakTerlayani: commit-e37d34f4
 */
final class FormTakTerlayani
{
...
namespace his.FatmaPharmacy.views.LaporanTakTerlayaniUi.FormTakTerlayani {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    constructor(divElm) {
        ...
        const laporanTakTerlayaniWgt = new spl.AjaxFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.LaporanTakTerlayaniUi.FormTakTerlayani.Fields} data */
            loadData(data) {
