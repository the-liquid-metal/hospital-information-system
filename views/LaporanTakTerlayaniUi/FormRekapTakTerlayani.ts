 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/laporan/laporan_rekap_harian_tdkterlayani.php the original file
 * last exist of tlm\his\FatmaPharmacy\views\LaporanUi\LaporanRekapHarianTakTerlayani: commit-e37d34f4
 */
final class FormRekapTakTerlayani
{
...
namespace his.FatmaPharmacy.views.LaporanTakTerlayaniUi.FormRekapTakTerlayani {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    constructor(divElm) {
        ...
        const laporanTakTerlayaniWgt = new spl.AjaxFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.LaporanTakTerlayaniUi.FormRekapTakTerlayani.Fields} data */
            loadData(data) {
