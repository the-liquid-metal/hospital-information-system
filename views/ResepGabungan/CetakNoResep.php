 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/resepgabungan/cetaknoresep.php the original file
 */
final class CetakNoResep
{
...
#<?= $pageId ?> .print_body table.daftar_obat tbody tr td:nth-child(3) {
    width: 2%;
    text-align: left;
}
...
#<?= $pageId ?> .print_body table.daftar_obat tr td:nth-child(4) {
    width: 15%;
    text-align: right;
}
...
<div class="print_wrapper">
    ...
    <table class="daftar_obat">
        ...
        <?php foreach ($halaman as $baris): ?>
            <tr>
                <td><?= $baris->noResep . " [" . $baris->transfer . " | " . $toUserPartialDatetime($baris->tanggalTransfer) . " ]" ?></td>
                <td>:</td>
                <td>Rp</td>
