 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Mutasi/mutasikatalogjeniskelompok.php the original file
 * @deprecated clone into 2 files below
 * @see \tlm\his\FatmaPharmacy\views\LaporanMutasi\ReportTriwulanKatalogJenisKelompok    the replacement
 * @see \tlm\his\FatmaPharmacy\views\LaporanMutasi\ReportBulanKatalogJenisKelompok    the replacement
 */
final class MutasiKatalogJenisKelompok
{
