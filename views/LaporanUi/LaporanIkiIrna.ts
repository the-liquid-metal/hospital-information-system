 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/laporan/laporanikiirna.php the original file
 */
final class LaporanIkiIrna
{
...
namespace his.FatmaPharmacy.views.Laporan.LaporanIkiIrna {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    _structure = {
        row_1: {
            widthColumn: {
                heading3: {text: tlm.stringRegistry._<?= $h("Laporan IKI IRNA") ?>}
            }
        },
        row_2: {
            widthColumn: {
    ...
    constructor(divElm) {
        ...
        const laporanWgt = new spl.AjaxFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.Laporan.LaporanIkiIrna.Fields} data */
            loadData(data) {
