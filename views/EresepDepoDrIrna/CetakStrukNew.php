...
namespace tlm\his\FatmaPharmacy\views\EresepDepoDrIrna;
 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/eresepdepodrirna/cetak-struk-new.php the original file
 */
...
<div class="print_wrapper">
        ...
        <?php foreach ($halaman as ["i" => $i, "subtotal_harga" => $subtotalHarga]): ?>
            ...
            <?php if ($obat->subtotalJumlah): ?>
                <tr>
                    ...
                    <td class="text-right"><?= $obat->subtotalJumlah ?></td>
                    <td>Rp</td>
    ...
    <?php if ($key == (count($daftarHalaman) - 1)): ?>
        <table class="total">
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                ...
                <td>:</td>
                <td>Rp</td>
                <td class="text-right"><?= $toUserInt($penjualan->totaljual) ?></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>:</td>
                <td>Rp</td>
                <td class="text-right"><?= $toUserInt($penjualan->totaljp) ?></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
