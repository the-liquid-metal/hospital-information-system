 ...
 */
final class FilterJumlahStokMaret16Bu
{
...
namespace his.FatmaPharmacy.views.MonitorStok.FilterJumlahStokMaret16Bu {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    _structure = {
        row_1: {
            widthColumn: {
                heading3: {text: tlm.stringRegistry._<?= $h("Persediaan Maret") ?>}
            }
        },
        row_2: {
            widthColumn: {
    ...
    constructor(divElm) {
        ...
        const saringWgt = new spl.AjaxFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.MonitorStok.FilterJumlahStokMaret16Bu.Fields} data */
            loadData(data) {
