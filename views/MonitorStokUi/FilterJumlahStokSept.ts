 ...
 */
final class FilterJumlahStokSept
{
...
namespace his.FatmaPharmacy.views.MonitorStok.FilterJumlahStokSept {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    _structure = {
        row_1: {
            widthColumn: {
                heading3: {text: tlm.stringRegistry._<?= $h("Laporan Persediaan September") ?>}
            }
        },
        row_2: {
            widthColumn: {
    ...
    constructor(divElm) {
        ...
        const saringWgt = new spl.AjaxFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.MonitorStok.FilterJumlahStokSept.Fields} data */
            loadData(data) {
