 ...
 */
final class FilterJumlahStokJuni16Bu
{
...
namespace his.FatmaPharmacy.views.MonitorStok.FilterJumlahStokJuni16Bu {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    _structure = {
        row_1: {
            widthColumn: {
                heading3: {text: tlm.stringRegistry._<?= $h("Persediaan Juni") ?>}
            }
        },
        row_2: {
            widthColumn: {
    ...
    constructor(divElm) {
        ...
        const saringWgt = new spl.AjaxFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.MonitorStok.FilterJumlahStokJuni16Bu.Fields} data */
            loadData(data) {
