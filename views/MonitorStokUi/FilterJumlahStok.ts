...
namespace his.FatmaPharmacy.views.MonitorStok.FilterJumlahStok {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    _structure = {
        row_1: {
            widthColumn: {
                heading3: {text: tlm.stringRegistry._<?= $h("Laporan Persediaan 30 Juni") ?>}
            }
        },
        row_2: {
            widthColumn: {
    ...
    constructor(divElm) {
        ...
        const saringWgt = new spl.AjaxFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.MonitorStok.FilterJumlahStok.Fields} data */
            loadData(data) {
