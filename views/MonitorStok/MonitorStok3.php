 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Monitorstok/monitorstok3.php the original file
 */
final class MonitorStok3
{
     ...
     */
    public function __construct(string $tableWidgetId, string $dokumenWidgetId, iterable $daftarStokKatalog, GenericData $adm)
    {
...
<style>
@media print {
    #<?= $pageId ?> tr.monitor_stok_description td:nth-child(1) {
        width: 30%;
    }

    #<?= $pageId ?> tr.monitor_stok_description td:nth-child(2) {
        width: 1%;
    }

    #<?= $pageId ?> tr.monitor_stok_title td p {
        font-size: 16px;
        font-weight: bold;
    }
    ...
    #<?= $pageId ?> .p_table2 tbody tr td:nth-child(3),
    ...
    #<?= $pageId ?> .p_table2 tbody tr td:nth-child(5) {
        width: 5%;
    }

    #<?= $pageId ?> .p_table2 tbody tr td:nth-child(6) {
        width: 7%;
        text-align: right;
    }
