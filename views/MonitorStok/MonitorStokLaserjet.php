 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Monitorstok/monitorstoklaserjet.php the original file
 */
final class MonitorStokLaserjet
{
...
@media print {
    ...
    #<?= $pageId ?> .monitor_stok_header tr:first-child td p {
        font-size: 12px;
        font-weight: normal;
    }
...
$(() => {
    ...
    const pageElm = document.querySelector("#<?= $pageId ?>");

    pageElm.querySelector(".last_page").innerHTML = `
        <div>
