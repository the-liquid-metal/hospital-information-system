 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/laporan/laporan_rekap.php the original file
 * last exist of tlm\his\FatmaPharmacy\views\LaporanUi\LaporanRekap: commit-e37d34f4
 */
final class FormPerTujuan
{
...
namespace his.FatmaPharmacy.views.LaporanPengeluaranUi.FormPerTujuan {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    constructor(divElm) {
        ...
        const laporanPerTujuanWgt = new spl.AjaxFormWidget({
            element: divElm.querySelector(".laporanPerTujuanFrm"),
            /** @param {his.FatmaPharmacy.views.LaporanPengeluaranUi.FormPerTujuan.Fields} data */
            loadData(data) {
        ...
        this._widgets.push(laporanPerTujuanWgt, tanggalAwalWgt, tanggalAkhirWgt);
        tlm.app.registerWidget(this.constructor.widgetName, laporanPerTujuanWgt);
    }
});
</script>
