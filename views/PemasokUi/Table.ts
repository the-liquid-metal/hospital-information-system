 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Pbf/index.php the original file
 */
final class Table
{
...
namespace his.FatmaPharmacy.views.PemasokUi.Table {
...
tlm.app.registerModule(class extends spa.BaseModule {
    ...
    _structure = {
        row_1: {
            widthColumn: {
                heading3: {text: tlm.stringRegistry._<?= $h("Daftar Pemasok") ?>}
            }
        },
        row_2: {
            widthColumn: {
            ...
            widthTable: {
                ...
                thead: {
                    tr: {
                        ...
                        td_2: {text: tlm.stringRegistry._<?= $h("Nama Pemasok") ?>},
    ...
    constructor(divElm) {
        ...
        const saringWgt = new spl.StaticFormWidget({
            ...
            /** @param {his.FatmaPharmacy.views.PemasokUi.Table.FormFields} data */
            loadData(data) {
