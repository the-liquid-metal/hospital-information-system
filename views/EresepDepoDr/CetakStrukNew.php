 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/eresepdepodr/cetak-struk-new.php the original file
 */
    ...
    <?php if ($key + 1 == $jumlahHalaman): ?>
        <table class="total">
            ...
            <tr>
                ...
                <td>:</td>
                <td>Rp</td>
                <td class="text-right"><?= $toUserInt($daftarLainnya[$key]["totalJp"]) ?></td>
            </tr>
