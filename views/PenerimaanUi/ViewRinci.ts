 ...
 *
 * @see http://localhost/ori-source/fatma-pharmacy/views/farmasi/Penerimaan/viewsrinci.php the original file
 */
...
namespace his.FatmaPharmacy.views.Penerimaan.ViewRinci {
...
tlm.app.registerModule(class extends spa.BaseModule {
            ...
            widthTable: {
                ...
                thead: {
                    tr_1: {
                        ...
                        td_12: /* 18-22 */ {colspan: 5, text: tlm.stringRegistry._<?= $h("Realisasi") ?>},
                    },
                    tr_2: {
                        ...
                        td_10: /* 18 */ {text: tlm.stringRegistry._<?= $h("Rencana") ?>},
                        td_11: /* 19 */ {text: tlm.stringRegistry._<?= $h("Spk") ?>},
                        td_12: /* 20 */ {text: tlm.stringRegistry._<?= $h("Do") ?>},
                        td_13: /* 21 */ {text: tlm.stringRegistry._<?= $h("Bonus") ?>},
                        td_14: /* 22 */ {text: tlm.stringRegistry._<?= $h("Terima") ?>},
                    }
                }
            }
        },
    ...
    constructor(divElm) {
        super();
        const {toCurrency: currency, numToShortMonthName: nToS, toUserDate: userDate, toUserInt: userInt} = tlm;
        ...
        const divWgt = new spl.DinamicContainerWidget({
            element: divElm,
            /** @param {his.FatmaPharmacy.views.Penerimaan.ViewRinci.ContainerFields} data */
            loadData(data) {
        ...
        const detailPenerimaanWgt = new spl.TableWidget({
            ...
            columns: {
                ...
                18: {formatter(unused, item) {
                    const {noUrut, jumlahRencana} = item;
                    return noUrut == "1" ? userInt(jumlahRencana) : "";
                }},
                19: {formatter(unused, item) {
                    const {noUrut, jumlahPl} = item;
                    return noUrut == "1" ? userInt(jumlahPl) : "";
                }},
                20: {formatter(unused, item) {
                    const {noUrut, jumlahPo} = item;
                    return noUrut == "1" ? userInt(jumlahPo) : "";
                }},
                21: {formatter(unused, item) {
                    const {noUrut, jumlahPo, jumlahPl, jumlahItemBeli, jumlahItemBonus} = item;
                    return noUrut == "1" ? currency((jumlahPo || jumlahPl) / (jumlahItemBeli * jumlahItemBonus)) : "";
                }},
