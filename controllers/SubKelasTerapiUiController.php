...
use tlm\his\FatmaPharmacy\controllers\SubKelasTerapiController as Pair;
use tlm\his\FatmaPharmacy\views\SubKelasTerapiUi\{Form, Table};
 ...
 */
class SubKelasTerapiUiController extends Controller
{
    /**
    ...
    public function actionForm(): string
    {
        $view = new Form(
            ...
            kelasTerapiAcplUrl: Yii::$app->actionToUrl([KelasTerapiController::class, "actionSelect"]),
