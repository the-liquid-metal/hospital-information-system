...
use tlm\his\FatmaPharmacy\controllers\SediaanController as Pair;
use tlm\his\FatmaPharmacy\views\SediaanUi\{Form, Table};
 ...
 */
class SediaanUiController extends Controller
{
    /**
    ...
    public function actionForm(): string
    {
        $view = new Form(
            ...
            cekUnikUrl:    Yii::$app->actionToUrl([Pair::class, "actionCekUnik"]),
        );
        return $view->__toString();
    }
}
